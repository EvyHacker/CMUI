package framework.pages.Form855b;
...
public class Application855b {

    private final Element beginSubmission;
    private final Element inAppReview;


    public Application855b(App app) {
        //beginSubmission = app.newElement(Locator.LINKTEXT, "Begin Submission");
